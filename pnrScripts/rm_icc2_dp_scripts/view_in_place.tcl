...
set stage_list ""
set i 0
foreach stage "$SPLIT_CONSTRAINTS_LABEL_NAME $INIT_DP_LABEL_NAME $PRE_SHAPING_LABEL_NAME $PLACE_IO_LABEL_NAME $SHAPING_LABEL_NAME $PLACEMENT_LABEL_NAME $CREATE_POWER_LABEL_NAME $CLOCK_TRUNK_PLANNING_LABEL_NAME $PLACE_PINS_LABEL_NAME $PRE_TIMING_LABEL_NAME $TIMING_ESTIMATION_LABEL_NAME $BUDGETING_LABEL_NAME $COPY_LABEL_NAME" { 
